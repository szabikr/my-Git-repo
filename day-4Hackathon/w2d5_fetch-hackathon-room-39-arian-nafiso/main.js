// API data
    // Create an async function to retrieve the data in JSON using fetch;
    // Convert that response data into a javascript object;
...
async function getTrivia(){
    ...
    console.log(data)
    let question = document.querySelector("#question")
    question.innerText = Convert(data.results[i].question);
...
// b1.addEventListener('click',(e) => {
//     if (a1.innerText === data.results[0].correct_answer){
//         alert("you win!")}
...
//Take in a username (restrict username to 10chars and maybe capitalise the first letter)
//Question at the top insert to H1;
//created list 
//insert data.results.incorrect/correct answers into list
//create buttons for each answer
//button=Options for answers, 1 correct and 3 incorrect;
//Buttons next to the answer and they can select;
//Right answer: Give a score;
//Wrong answer: Do nothing, send a message;
